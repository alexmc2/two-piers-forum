        ...
        <div className="mt-5">
          ...
          <button
            ...
            className={
              toggleCheckbox
                ? 'main-btn active'
                : 'main-btn disabled hover:bg-button-initial group'
            }
            type="submit"
          >
            <div className="continue">
              {loadingButton ? <Loading /> : 'Continue'}
            </div>
          ...
          <div
            ...
            className="text-link text-sm pt-1 font-medium hover:underline cursor-pointer"
          >
