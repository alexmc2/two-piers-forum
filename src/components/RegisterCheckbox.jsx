    ...
    <div className="flex items-center mr-2 mt-[25px] px-[1px]">
      <div className="flex justify-center items-center w-[22px] h-[22px] relative rounded-md outline outline-border outline-1">
        <input
          ...
          name="checkbox"
          id="checkbox"
          className="cursor-pointer w-[22px] h-[22px] rounded-md relative before:w-full before:h-full before:bg-main-gray before:block before:rounded-md appearance-none"
          onClick={() => {
        ...
        />
        <div
          className="cursor-pointer absolute rounded-md w-[22px] h-[22px] z-10 pt-[2px] pl-[1.5px] bg-button-initial"
          onClick={() => {
      ...
      <div className="text-xs pl-[9px]">
        <p
          ...
          className="inline cursor-pointer text-overlay-text"
        >
          I have read and agree to Two Piers&apos; terms and conditions{' '}
        </p>
        <a
