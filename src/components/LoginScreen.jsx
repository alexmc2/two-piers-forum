  ...
  return (
    ...
    >
      <form onSubmit={handleLogSubmit}>
        <div>
          <h1 className="font-semibold text-2xl text-center mb-2 leading-[30px]">
            Welcome to Two Piers Members&apos; Area
          </h1>
          <p className="font-normal text-secondary-gray text-center leading-[20px]">
            Log in to access your Two Piers account.
          </p>
        </div>
        <div className="w-full text-left mt-5">
          ...
          <button className="mt-1">
            <div
              ...
              className="font-medium text-link text-sm hover:underline"
            >
              Forgot your password?
            </div>
          </button>
          <button onClick={handleLogSubmit} className="main-btn" type="submit">
            {loadingButton ? <Loading /> : 'Log in'}
          </button>
          <div className="mt-0.5 text-sm">
            ...
            <button
              ...
              className="pl-1"
            >
              <div className="text-link font-medium hover:underline">
                Register
              </div>
            </button>
          </div>
